...
public class DBListenerEvent extends Event {
    ...
    private static final String interfaceTableDefault = "dbo.MSB_XML_OUT";
...
//          TODO Remove this MCES bullshit after they get LC tables with version 1.1 like they should have by now
    ...
    private void enrichTemplate() {
        ...
        if (msbHeaderMappingVersion != null ) enrichElement(MSBHEADER_XML_TAG, HEADER_VERSION,getMsbHeaderMappingVersion());
        
        String targetQueue = DEFAULT_TARGET_QUEUE;
        if (!targets.isEmpty()){
            targetQueue = QueueNameAssembler.assembleMultiQueue(targets);
        }        
