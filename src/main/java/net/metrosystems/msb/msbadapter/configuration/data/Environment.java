...
public class Environment {
	...
	private static final String DB_CONNECTION_TAG = "DBConnection";
	private static final String DB_DRIVER_TAG = "DBDriver";
	...
	private void initFromElement(Element el) {
		...
		if (null != el.getChild(DB_CONNECTION_TAG).getValue()) {
			dbConnection = el.getChild(DB_CONNECTION_TAG).getValue();
		}
		if (null != el.getChild(DB_DRIVER_TAG).getValue()) {
			dbDriver = el.getChild(DB_DRIVER_TAG).getValue();
		}
	}
